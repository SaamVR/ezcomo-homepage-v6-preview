(() => {
  ...
  const i18n = {
    en:{
      ...
      createStore:'Create free store',seeStores:'See how it works',trustNoCode:'No code required',trustTemplate:'Start from a template',trustLocal:'Local commerce workflows',
  ...
  Object.assign(i18n.en,{
    ...
    priceBasicNote:'For one store that needs the core CMS, theme tools and manual or assisted payments.',basicFeature1:'1 storefront',basicFeature2:'Core CMS blocks + theme tools',basicFeature3:'14-day trial',chooseBasic:'Choose Basic',
    priceAdvancedNote:'For growing teams running campaigns and richer storefront operations.',advancedFeature1:'Up to 3 storefronts',advancedFeature2:'Campaigns, teams, coupons + reviews',advancedFeature3:'14-day trial',chooseAdvanced:'Choose Advanced',
  ...
  Object.assign(i18n.bn,{
    ...
    priceBasicNote:'একটি store-এর জন্য core CMS, theme tools এবং manual/assisted payment দরকার হলে।',basicFeature1:'১টি storefront',basicFeature2:'Core CMS blocks + theme tools',basicFeature3:'১৪ দিনের ট্রায়াল',chooseBasic:'Basic বেছে নিন',
    priceAdvancedNote:'Growing team, campaign আর richer storefront operation-এর জন্য।',advancedFeature1:'সর্বোচ্চ ৩টি storefront',advancedFeature2:'Campaign, team, coupon + review',advancedFeature3:'১৪ দিনের ট্রায়াল',chooseAdvanced:'Advanced বেছে নিন',
  ...
  const applyTheme=next=>{
    ...
    sessionStorage.setItem('ezcomo-release-theme',next);
    syncLampState();
  };
  ...
  const rememberedTheme=sessionStorage.getItem('ezcomo-release-theme');
